...
import { ResourceLink, ResourceIcon } from '../../utils';
...
export const EventItem: React.FC<EventItemProps> = React.memo(({ event, isExpanded, onToggle }) => {
    ...
    <div className="co-recent-item__body">
      <AccordionItem>
        <AccordionToggle
          ...
          isExpanded={expanded}
          id={metadata.uid}
          className={classNames('co-recent-item__toggle', {'co-recent-item--error': isError && expanded})}
        >
          <div className="co-recent-item__title">
            ...
            <div className="co-recent-item__title-message">
              {isError && <RedExclamationCircleIcon className="co-dashboard-icon co-recent-item__icon--error" />}
              {!expanded && (
                <>
