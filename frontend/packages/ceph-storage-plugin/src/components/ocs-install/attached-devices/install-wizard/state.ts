...
import { NodeKind, StorageClassResourceKind } from '@console/internal/module/k8s';
...
export type Action =
  ...
  | { type: 'setCapacity'; value: string }
  | { type: 'setNodes'; value: NodeKind[] }
  | { type: 'setEncryption'; value: boolean }
  | { type: 'setMinimal'; value: boolean };
