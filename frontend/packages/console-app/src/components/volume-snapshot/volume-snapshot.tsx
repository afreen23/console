...
import { TableRow, TableData, ListPage, Table } from '@console/internal/components/factory';
import {
  NamespaceModel,
...
const Row: React.FC<RowProps> = ({ key, obj, style, index }) => {
...
export const VolumeSnapshotPage: React.FC = (props) => {
  return (
    <ListPage
      {...props}
      kind={referenceForModel(VolumeSnapshotModel)}
